...
class ReplayValidationTests(unittest.TestCase):
    ...
    def test_accepts_step_functions_topology(self):
        self.manifest["snapshots"] = [{
            "resource": {"service": "stepfunctions", "type": "state_machine", "id": "orders"},
            "service": "stepfunctions", "structure_version": 1,
            "structure": {"name": "orders", "arn": "arn:aws:states:eu-west-1:123456789012:stateMachine:orders", "tags": []},
        }]
        self.write_json("bundle/manifest.json", self.manifest)
