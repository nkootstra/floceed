...
func (panicInspectRuntime) Reset(context.Context, string, string) ([]byte, error) {
	panic("inspect must not call Docker")
}
...
func (r *inspectRuntimeStub) Reset(context.Context, string, string) ([]byte, error)  { return nil, nil }
